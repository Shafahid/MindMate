  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative flex h-screen w-full items-center justify-center bg-white dark:bg-black pt-20">
        ...
        <div className="absolute top-32 left-16 md:left-32 z-10 animate-float">
        ...
        <div className="absolute top-40 right-12 md:right-28 z-10 animate-float-delay">
          <div className="bg-gradient-to-r from-violet-500 to-gray-500 text-white px-4 py-2 rounded-full text-sm font-medium shadow-lg backdrop-blur-sm">
            24/7 AI Support Available
          </div>
        </div>

        <div className="absolute bottom-40 left-12 md:left-24 z-10 animate-float-slow">
          <div className="bg-gradient-to-r from-violet-500 to-gray-500 text-white px-4 py-2 rounded-full text-sm font-medium shadow-lg backdrop-blur-sm">
            100% Anonymous & Safe
          </div>
        </div>

        <div className="absolute bottom-32 right-16 md:right-32 z-10 animate-float">
          <div className="bg-gradient-to-r from-violet-500 to-gray-500 text-white px-4 py-2 rounded-full text-sm font-medium shadow-lg backdrop-blur-sm">
            Join 10,000+ Students
          </div>
        </div>

        <div className="absolute top-1/2 left-8 md:left-16 z-10 animate-float-delay">
        ...
        <div className="absolute top-1/3 right-8 md:right-20 z-10 animate-float-slow">
          <div className="bg-gradient-to-r from-violet-500 to-gray-500 text-white px-3 py-2 rounded-full text-xs font-medium shadow-lg backdrop-blur-sm">
            Peer Support
          </div>
        </div>
