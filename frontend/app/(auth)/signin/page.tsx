...
import { signIn } from '../../../lib/auth'  // Supabase login helper
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden p-4 font-nohemi">
      ...
      <div className="z-10 w-full max-w-6xl">
        <div className="bg-purple-100/30 overflow-hidden rounded-[40px] border border-purple-300">
          <div className="grid min-h-[700px] lg:grid-cols-2">
            ...
            <div className="brand-side relative m-4 rounded-3xl bg-[url('/login.jpg')] bg-cover bg-center p-12 text-white">
              ...
              <div className="relative z-10">
                <div className="mb-12 text-lg font-semibold">MindMate</div>
                <h1 className="mb-4 text-6xl font-medium">Your Mental Health Companion</h1>
                ...
                <div className="space-y-6">
                  {[
                    { icon: <Brain size={16} />, title: 'AI-Powered Support', desc: 'Intelligent mental health guidance' },
                    { icon: <Heart size={16} />, title: 'Personalized Care', desc: 'Tailored wellness plans just for you' },
                    { icon: <Users size={16} />, title: 'Community Support', desc: 'Connect with others on similar journeys' },
                    { icon: <Shield size={16} />, title: 'Privacy & Security', desc: 'Your mental health data is always protected' },
            ...
            <div className="flex flex-col justify-center p-12">
              <div className="mx-auto w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    <label htmlFor="email" className="mb-2 block text-sm font-medium uppercase">Email address</label>
                  ...
                  <div>
                    <label htmlFor="password" className="mb-2 block text-sm font-medium uppercase">Password</label>
                    <div className="relative">
                      <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                  ...
                  <div className="flex items-center justify-between">
                    <label className="text-muted-foreground flex items-center text-sm">
                      <input type="checkbox" className="border-border text-primary h-4 w-4 rounded" />
                      <span className="ml-2">Remember me</span>
                    </label>
                    <a href="/forgot-password" className="text-primary hover:text-primary/80 text-sm">
                      Forgot password?
                    </a>
                  </div>
                ...
                <div className="text-muted-foreground mt-8 text-center text-sm">
                  ...
                  <a href="/signup" className="text-primary hover:text-primary/80">Sign up for free</a>
                </div>
              </div>
            </div>
          </div>
